    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-400 mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <MetricCard
            title="Total Revenue"
            value={analytics?.totalGrandTotal || 0}
          ...
          <MetricCard
            ...
            value={data?.totalOverallPurchase || 0}
            Icon={FaBangladeshiTakaSign}
          ...
          <MetricCard
            ...
            Icon={FaBangladeshiTakaSign}
            description={`${(
              analytics?.totalPaidAmount || 0
            ).toLocaleString("bn-BD", { minimumFractionDigits: 2 })}`}
            trend={null}
          />
          <MetricCard
            title="Due Amount"
            value={analytics?.totalDueAmount || 0}
            Icon={FaBangladeshiTakaSign}
